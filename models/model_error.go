...
var (
	...
	ErrOneOfParameterHaveIncorrectFormat = Error{Message: "One of parameter have incorrect format", Code: 40}
	ErrEntityNotFound                    = Error{Message: "Entity with such id not found", Code: 50}
